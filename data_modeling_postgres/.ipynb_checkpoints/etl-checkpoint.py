...
def process_song_file(cur, filepath):
    ...
    Artist information is inserted into the 'artists' table
    Song information is inserted into the 'songs' table
...
def process_log_file(cur, filepath):
    ...
    User informatino is inserted into the 'user' table
    Songplay informatino is inserted into the 'songplays' table
    
    Args:
    cur (psycopg2 cursor): Database cursor
    filepath (str): Filepath to a log file
    """
    # open log file
    df = pd.read_json(filepath, lines=True)
...
def process_data(cur, conn, filepath, func):
    """
    Processes JSON files for data directory path
    
    Valid function values can be 'process_song_file' or 'process_log_file'
    
    Args:
    cur (psycopg2.cursor): Database cursor
    conn (psycop2.connection): Database connection
    filepath (str): Filepath of the directory to process
